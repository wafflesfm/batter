...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Upload.parent'
        db.delete_column(u'torrents_upload', 'parent_id')

        # Adding field 'Upload.parent_content_type'
        db.add_column(u'torrents_upload', 'parent_content_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['contenttypes.ContentType']),
                      keep_default=False)

        # Adding field 'Upload.parent_object_id'
        db.add_column(u'torrents_upload', 'parent_object_id',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Upload.parent'
        raise RuntimeError("Cannot reverse this migration. 'Upload.parent' and its values cannot be restored.")
        # Deleting field 'Upload.parent_content_type'
        db.delete_column(u'torrents_upload', 'parent_content_type_id')

        # Deleting field 'Upload.parent_object_id'
        db.delete_column(u'torrents_upload', 'parent_object_id')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Torrent.md5sum'
        db.alter_column(u'torrents_torrent', 'md5sum', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))

    def backwards(self, orm):

        # Changing field 'Torrent.md5sum'
        db.alter_column(u'torrents_torrent', 'md5sum', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    models = {
        ...
        u'torrents.upload': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'uploads'", 'to': u"orm['torrents.TorrentGroup']"}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Torrent.announce'
        db.alter_column(u'torrents_torrent', 'announce', self.gf('django.db.models.fields.URLField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'Torrent.announce'
        db.alter_column(u'torrents_torrent', 'announce', self.gf('django.db.models.fields.TextField')())
